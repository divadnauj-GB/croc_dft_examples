...
if {[shell_is_in_topographical_mode] && ${SYN_MODE} == "dcg" && ![shell_is_in_exploration_mode]} {
	set compile_command "compile_ultra   -gate_clock -spg -scan"
...
if {${MODULE}=="NV_NVDLA_partition_a"} {
    remove_design RAMDP_16X272_GL_M1_E2
    remove_design RAMDP_16X256_GL_M1_E2
} 

if {${MODULE}=="NV_NVDLA_partition_c"} {
    remove_design RAMPDP_256X64_GL_M2_D2
    remove_design RAMDP_16X64_GL_M1_E2
    remove_design RAMDP_8X66_GL_M1_E2
    remove_design RAMDP_128X6_GL_M2_E2
    remove_design RAMDP_128X11_GL_M2_E2
} 

if {${MODULE}=="NV_NVDLA_partition_m"} {
    puts ${MODULE}
} 

if {${MODULE}=="NV_NVDLA_partition_o"} {
    remove_design RAMDP_256X4_GL_M2_E2
    remove_design RAMDP_256X8_GL_M2_E2
    remove_design RAMPDP_128X18_GL_M2_D2
    remove_design RAMDP_8X66_GL_M1_E2
    remove_design RAMDP_80X9_GL_M2_E2
    remove_design RAMPDP_80X17_GL_M2_D2
    remove_design RAMDP_60X22_GL_M1_E2
} 

if {${MODULE}=="NV_NVDLA_partition_p"} {
    remove_design RAMDP_16X14_GL_M1_E2
    remove_design RAMDP_16X16_GL_M1_E2
    remove_design RAMDP_16X66_GL_M1_E2
    remove_design RAMDP_8X66_GL_M1_E2
} 
