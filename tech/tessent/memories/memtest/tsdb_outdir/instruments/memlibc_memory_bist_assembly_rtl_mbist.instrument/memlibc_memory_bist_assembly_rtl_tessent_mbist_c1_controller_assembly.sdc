...
#          Version: 2022.3
#       Created on: Sat Nov 15 20:33:32 EST 2025
#--------------------------------------------------------------------------
...
proc tessent_set_ijtag_non_modal {} {  
  ...
  set_multicycle_path -hold 2 \
      -from [tessent_get_ports [list {ijtag_select}]] 
  set_input_delay  $local_input_delay -clock $tessent_clock_mapping(tessent_tck) [tessent_get_ports {capture_en}]  -clock_fall
  set_input_delay  $local_input_delay -clock $tessent_clock_mapping(tessent_tck) [tessent_get_ports {shift_en}]  -clock_fall
  set_input_delay  $local_input_delay -clock $tessent_clock_mapping(tessent_tck) [tessent_get_ports {update_en}] 
  set_input_delay  $local_input_delay -clock $tessent_clock_mapping(tessent_tck) [tessent_get_ports {ijtag_select}]  -clock_fall
